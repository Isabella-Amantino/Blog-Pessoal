...
@Table(name = "tb_postagens") //cria o nome da tabela
public class Postagem {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)//gera o auto_increment
	...
	@ManyToOne  //Configurando  relações de muitos para um
